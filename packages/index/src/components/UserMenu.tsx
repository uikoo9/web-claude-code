...
interface UserMenuProps {
  ...
  username: string;
  email: string;
  onAccessTokensClick: () => void;
}

export const UserMenu = ({ avatarUrl, displayName, username, email, onAccessTokensClick }: UserMenuProps) => {
    ...
    <div className="user-menu" ref={menuRef}>
      ...
      {isOpen && (
        <div className="user-menu-dropdown">
          ...
          {/* Menu Items */}
          <button className="menu-item" onClick={handleAccessTokens}>
            {t('accessTokens')}
          </button>
